...
document.getElementById('flagButtonOne').addEventListener('click', sendStartRequest)
document.getElementById('flagButtonTwo').addEventListener('click', sendStopRequest)
